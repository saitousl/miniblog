...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reply" do
    assert_difference('Reply.count') do
      post replies_url, params: { reply: { comment: @reply.comment, topic_id: @reply.topic_id } }
    end
  ...
  test "should update reply" do
    patch reply_url(@reply), params: { reply: { comment: @reply.comment, topic_id: @reply.topic_id } }
